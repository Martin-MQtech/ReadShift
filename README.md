...
```text
ReadShift 知识与工程矩阵
├── README.md (本项目总领 · 全景概览 / 哲学发心 / 通用管线 / 资产矩阵)
...
│
├── 📚 01-典藏重塑作品系列_Remastered_Editions/ (支柱 01：官方出版级电子书重塑示范)
│   ├── README.md (排版规范与全书仅私域研读分发边界声明)
│   ├── 00-官方标杆：张忠谋自传双语典藏版/ (官方示范 · HTML/EPUB/PDF 高清排版实录)
│   └── 01-社区共创作品展台/ (汇聚社区创作者重塑的典藏读物)
│
├── 🎙️ 02-平行叙事衍生创作_Parallel_Universe/ (支柱 02：官方100%自主版权二创示范)
│   ├── README.md (二创深度与公网全量开源开放分发政策)
│   ├── 00-官方标杆：台积电张忠谋·传记时间线的声音世界/ (官方示范 · 双轨音频 MP3 + 剧本)
│   └── 01-社区共创创作展台/ (汇聚社区创作者衍生的 AI 播客与剧本)
│
├── 🛠️ 03-社区共创与内容再造工坊_Community_Studio/ (支柱 03：多模态文化与知识再造枢纽)
...
│   ├── PROMPTS.md (Prompt 矩阵 · 语境自适应与艾萨克森/韩寒/余秋雨风格 DLC)
│   ├── DESIGN_PLAN.md (排版美学与纸书设计系统 · Tschichold 黄金网格与防撕裂)
