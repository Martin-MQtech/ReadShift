...
│
├── 🛠️ cli/ (统一命令行接口 · init / build / epub / qa / check)
...
│
├── 🏛️ works_成果展厅与多模态再造工坊/ 【成果展厅与多模态再造工坊 · 结果性作品收拢于底层】
│   ├── README.md (展厅导览、全源输入矩阵与版权声明)
│   ├── 01-官方示范：张忠谋自传双语典藏版/ (官方示范 01 · 出版级排版实录与视觉截图)
│   ├── 02-官方示范：台积电张忠谋·传记时间线的声音世界/ (官方示范 02 · 100%原创双轨广播剧与剧本)
│   └── 03-社区共创与多模态再造工坊/ (社区展台 / 古籍书法线索池 / 内容再造提案)
│
